    ...
    echo $email.' '.$nome.' '. $cognome.' '.$_POST[genere].' '.$_POST[gg].' '.$_POST[mese].' '.$_POST[anno].' '.$hash.' '.$_SESSION['errorePres'];
		...
		<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post"  >
            ...
            <!-- NB: mettere età e genere nella stessa riga --> 
            						...
            						<div class="nascita">
            						  <input  name="gg" type="number" class="nascita" placeholder="GG" min ="1" max="31" required>
                    	 		    </div>
                    	 		    <div class="nascita">
                    	 		      <input name="mese" type="number" class="nascita" placeholder="Mese" min="1" max="12" required>
                    	 		   </div>
                    	 		   <div class="nascita">
                    	 		     <input name="anno" type="number" class="nascita" placeholder="Anno" min="1900" max="2004" required>
                    	 		   </div>
                    	       </div>
